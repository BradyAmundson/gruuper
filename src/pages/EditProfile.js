    ...
    return (
        <Container maxWidth="sm">
            <Paper elevation={3} style={paperStyle}>
                ...
                <FormControl fullWidth margin="normal">
                    <InputLabel id="time-of-day-preference-label">Are you more of a night or morning person?</InputLabel>
                    <Select
                ...
                <FormControl fullWidth margin="normal">
                    <InputLabel id="social-preference-label">How do you prefer to do your school work?</InputLabel>
                    <Select
                ...
                <FormControl fullWidth margin="normal">
                    <InputLabel id="deadline-behavior-label">Give it to me straight: How are you with deadlines?</InputLabel>
                    <Select
                    ...
                    >
                        ...
                        <MenuItem value={"3"}>30% leading up to it, 70% the night before.</MenuItem>
                        <MenuItem value={"4"}>Biggest 24hr comebacks the world has ever seen.</MenuItem>
                    </Select>
                </FormControl>
